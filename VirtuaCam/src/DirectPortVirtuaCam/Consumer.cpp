// File: src/DirectPortVirtuaCam/Consumer.cpp
...
HRESULT Consumer::Initialize(ID3D11Device* device) {
...
const std::vector<DiscoveredSharedStream>& Consumer::GetDiscoveredStreams() const { 
