...
public:
	...
	Activator() { SetBaseAttributesTraceName(L"ActivatorAtts"); }
	HRESULT Initialize();
private:
#if _DEBUG
...
public:
	MediaStream() : _index(0), _state(MF_STREAM_STATE_STOPPED), _format(GUID_NULL), _initialWidth(0), _initialHeight(0), _currentWidth(0), _currentHeight(0) { SetBaseAttributesTraceName(L"MediaStreamAtts"); }
